class SkillTagTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @skill_tag_type.save
        format.html { redirect_to @skill_tag_type, notice: 'Skill tag type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @skill_tag_type.update(skill_tag_type_params)
        format.html { redirect_to @skill_tag_type, notice: 'Skill tag type was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to skill_tag_types_url, notice: 'Skill tag type was successfully destroyed.' }

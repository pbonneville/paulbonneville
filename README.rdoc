...
The is currently a Heroku hosted site that uses:
 ...
 - Postgres, since that is what Heroku uses and it minimizes conflicts that WILL come up if you use MySQL for development. I am using the [Postgres.app](http://postgresapp.com) locally, which is the simplest way
 to get up and running on your local machine in my opinion.

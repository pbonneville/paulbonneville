...
DateTime::DATE_FORMATS[:default] = "%B %d, %Y %P" # November 3, 2013 14:22
Time::DATE_FORMATS[:blog_post] = "%B %d, %Y" # November 3, 2013 14:22
...
Time::DATE_FORMATS[:default] = "%B %e, %Y %l:%M%P"           # November 3, 2013 14:22
